...
class LLMService:
    ...
    async def classify_query(self, classification_prompt: str, system_prompt: str = None) -> Dict[str, Any]:
        """
        Make API call to LLM for query classification
        
        Args:
            classification_prompt: The prompt for classification.
        ...
        final_system_prompt = system_prompt or "You are a cricket query classifier. Respond only in valid JSON format."
        
        messages = self.provider.format_messages(final_system_prompt, classification_prompt)
